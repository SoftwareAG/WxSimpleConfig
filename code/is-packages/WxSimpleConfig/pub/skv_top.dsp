<html>
  ...
  <script>
	...
	window.updateMainPageLink = function (a){
       a.setAttribute('href', 'index.dsp');
    ...
    %ifvar message%
      %ifvar norefresh%
      %else%
        setTimeout("loadPage('dipRouting_top.dsp')", 30000);
      %endif%
    %endif%
          ...
          %invoke wm.server:getSessionID% 
            ...
            %else%
              %invoke wm.server.quiesce:getCurrentMode%
                ...
                %endif%
              %endinvoke%
                            <a target="if3"  id="aif3" href="#"  onclick="updateMainPageLink(this);">Back to Main Page
                            </a>
                            |
